...
namespace ManoMotion.Visualization
{
    ...
    public class HandOcclusion : MonoBehaviour
    {
        ...
        private void Start()
        {
            // Cache references
            SetWristJoints();
            occlusionRGBTextures[0] = ManoMotionManager.Instance.VisualizationInfo.leftHandMask;
            occlusionRGBTextures[1] = ManoMotionManager.Instance.VisualizationInfo.rightHandMask;
        }
